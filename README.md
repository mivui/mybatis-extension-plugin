...
##### examples
* The <plugin> element is used to define the plugin. The plug-in can be used to extend or modify the code generated by MyBatis Generator (MBG). This element is a child element of the <context> element. Any number of plugins can be specified in the context.
```xml
